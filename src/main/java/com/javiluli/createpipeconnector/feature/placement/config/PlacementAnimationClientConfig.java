...
public final class PlacementAnimationClientConfig {
    private static ForgeConfigSpec.BooleanValue animationEnabled;
    private static ForgeConfigSpec.BooleanValue zoomEnabled;
    private static ForgeConfigSpec.BooleanValue fullRoutePreview;
    private static ForgeConfigSpec.BooleanValue nextPiecePreview;
    private static ForgeConfigSpec.IntValue delayTime;
    ...
    public static boolean isAnimationEnabledInConfigScreen() {
        return ConfigHelper.getValue(
                String.join(".", animationEnabled.getPath()),
                animationEnabled
        );
    }
