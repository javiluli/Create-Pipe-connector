...
public final class PlacementAnimationClientConfig {
    ...
    private static final ModConfigSpec.BooleanValue ANIMATION_ENABLED;
    private static final ModConfigSpec.BooleanValue FULL_ROUTE_PREVIEW;
    private static final ModConfigSpec.BooleanValue NEXT_PIECE_PREVIEW;
    private static final ModConfigSpec.EnumValue<PlacementAnimationSpeed> SPEED_PRESET;
    ...
    /** Devuelve el valor visible aunque la pantalla aun no lo haya guardado. */
