...
public final class MissingMaterialsAlertHud {
    private static final net.minecraft.resources.ResourceLocation LAYER_ID = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "missing_materials_alert");
    ...
    public static void register(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.HOTBAR, LAYER_ID, MissingMaterialsAlertHud::render);
    }
