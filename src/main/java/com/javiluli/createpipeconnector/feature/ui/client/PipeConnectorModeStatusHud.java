...
public final class PipeConnectorModeStatusHud {
    private static final net.minecraft.resources.ResourceLocation LAYER_ID = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "pipe_connector_mode_status");
    ...
    public static void register(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.HOTBAR, LAYER_ID, PipeConnectorModeStatusHud::render);
    }
