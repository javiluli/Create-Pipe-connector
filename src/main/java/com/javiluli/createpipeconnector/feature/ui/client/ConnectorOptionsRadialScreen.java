...
public final class ConnectorOptionsRadialScreen extends Screen {
    ...
    private enum Mechanic {
        ...
        AUTO_PUMPS("auto_pumps") {
            /** Devuelve los modos de bombas disponibles. */
            @Override
            RadialOption[] options() {
        ...
        PUMP_DIRECTION("pump_direction") {
            /** Devuelve los sentidos de bombas disponibles. */
            @Override
            RadialOption[] options() {
                return PumpDirectionOption.VALUES;
            }

            /** Devuelve el sentido de bombas aplicado actualmente. */
            @Override
            RadialOption activeOption() {
    ...
    private enum RouteStyleOption implements RadialOption {
        ...
        public boolean apply() {
            ...
            CreatePipeConnectorNetwork.sendToServer(new RoutePriorityPayload(priority));
            return true;
        }
    }
    ...
    private enum PumpModeOption implements RadialOption {
        ...
        public boolean apply() {
            ...
            CreatePipeConnectorNetwork.sendToServer(new PumpModePayload(mode));
            return true;
        }
    }
    ...
    private enum PumpDirectionOption implements RadialOption {
        ...
        /** Crea una opcion para el estado de inversion indicado. */
        ...
        /** Indica si este sentido esta activo. */
        @Override
        public boolean isActive() {
            return ClientPipeConnectorState.isAutoPumpDirectionReversed() == reversed;
        }

        /** Aplica y sincroniza este sentido de bombas. */
        @Override
        public boolean apply() {
