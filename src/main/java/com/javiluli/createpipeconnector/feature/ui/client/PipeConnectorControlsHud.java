...
public final class PipeConnectorControlsHud {
    ...
    private static final int BEACON_ICON_SIZE = 18;
    private static final int BEACON_ICON_RENDER_SIZE = 12;
    private static final int BEACON_ICON_TEXTURE_Y = 220;
    private static final int BEACON_CONFIRM_TEXTURE_X = 90;
    private static final int BEACON_CANCEL_TEXTURE_X = 112;
    private static final ResourceLocation BEACON_TEXTURE = ResourceLocation.fromNamespaceAndPath(
            "minecraft",
    ...
    private static void renderMaterialStatus(
        ...
        float iconScale = (float) BEACON_ICON_RENDER_SIZE / BEACON_ICON_SIZE;
        guiGraphics.pose().pushPose();
        guiGraphics.pose().translate(x, y + 2, 0.0F);
        ...
        try {
            guiGraphics.blit(
                    ...
                    0,
                    0,
                    entry.hasEnough() ? BEACON_CONFIRM_TEXTURE_X : BEACON_CANCEL_TEXTURE_X,
                    BEACON_ICON_TEXTURE_Y,
                    BEACON_ICON_SIZE,
                    BEACON_ICON_SIZE
            );
        } finally {
