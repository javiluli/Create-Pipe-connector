...
public final class CreatePipeConnectorNetwork {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(PumpDirectionPayload.TYPE, PumpDirectionPayload.STREAM_CODEC, ServerPumpPayloadHandler::handlePumpDirection);
        ...
        registrar.playToServer(RemoveAnchorPayload.TYPE, RemoveAnchorPayload.STREAM_CODEC, ServerAnchorPayloadHandler::handleRemoveAnchor);
        ...
        registrar.playToServer(
                ShulkerMaterialSettingsPayload.TYPE,
                ShulkerMaterialSettingsPayload.STREAM_CODEC,
