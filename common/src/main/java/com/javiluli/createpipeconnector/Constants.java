...
/**
 * Shared identifiers, translation keys and stable gameplay thresholds.
 */
public final class Constants {
    ...
    public static final String PAYLOAD_ADD_ANCHOR = "add_anchor";
    public static final String PAYLOAD_CANCEL_CONNECTION = "cancel_pipe_connection";
    public static final String PAYLOAD_COPPER_CASING_MODE = "copper_casing_mode";
    public static final String PAYLOAD_PIPE_STYLE_MODE = "pipe_style_mode";
    public static final String PAYLOAD_PUMP_MODE = "pump_mode";
    public static final String PAYLOAD_REMOVE_ANCHOR = "remove_last_anchor";
    public static final String PAYLOAD_REMOVE_CASING = "remove_last_copper_casing";
    public static final String PAYLOAD_REMOVE_PUMP = "remove_last_manual_pump";
    public static final String PAYLOAD_REVERSE_PUMPS = "reverse_auto_pump_direction";
    public static final String PAYLOAD_ROUTE_PRIORITY = "route_priority";
    public static final String PAYLOAD_SELECT_TARGET = "select_pipe_target";
    public static final String PAYLOAD_TOGGLE_AUTO_PUMPS = "toggle_auto_pumps";
    public static final String PAYLOAD_TOGGLE_CONNECTOR = "toggle_connector_mode";
    public static final String PAYLOAD_TOGGLE_CASING = "toggle_copper_casing";
    public static final String PAYLOAD_TOGGLE_MANUAL_PUMP = "toggle_manual_pump";
    public static final String PAYLOAD_WRENCH_DISPLAY = "wrench_pipe_display";
